...
userRouter.post('/updatehighestdistance',checkUserLogin,updateHighestDistanceController);
userRouter.post('/updatetotaldistance',checkUserLogin,updateTotalDistanceController);
